...
import asd.com.delagate.CommunityCollegeLDelagate;
import asd.com.delagate.CommunityCollegeSDelagate;
...
//        mGridView.setEmptyView(findViewById(android.R.id.empty));
        ...
        MultiItemTypeAdapter adapter = new MultiItemTypeAdapter(this,strings);
        adapter.addItemViewDelegate(new CommunityCollegeLDelagate());
        adapter.addItemViewDelegate(new CommunityCollegeSDelagate());
